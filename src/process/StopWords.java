...
public class StopWords {
    ...
    public String processStopWordRemoval(String [] tokens){
        String temp, tokensWithNoStopWords = " ";
        for (int i = 0; i < tokens.length; i++) {
            temp = removeStopWords(tokens[i]);
            tokensWithNoStopWords = tokensWithNoStopWords + temp;
        }
        return tokensWithNoStopWords;
    }
